	...
	@include('admin_dashboard.page_name')
				...
				<div class="card-body">
					<form 
                		...
                		novalidate 
                		method="POST" 
                		action="{!! url('/update_media/'.$media->id); !!}">
                		{{ method_field('PATCH') }}
                		{{ csrf_field() }}
                		...
                		<div class="form-group row {{ $errors->has('title') ? ' has-error' : '' }}">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" id="title" name="title" placeholder="title" value="{{ $media->title }}" required>
							...
							<div class="row">
								...
								<div class="col-sm-10">
									<div class="form-check">
										<input class="form-check-input" type="radio" name="is_active" id="is_active_1" value="1" {{ ($media->is_active == '1')?'checked':'' }}>
										<label class="form-check-label" for="is_active_1">
										Yes
										</label>
									</div>
									<div class="form-check">
										<input class="form-check-input" type="radio" name="is_active" id="is_active_2" value="0" {{ ($media->is_active == '0')?'checked':'' }}>
						...
						<div class="row" style="margin-bottom: 10px;">
							<div class="col-sm-3">
								<div class="card" style="width: 15rem;">
									<input type="hidden" name="old_image_1" value="{{ $media->image_1 }}">
								  	<img 
							...
							<div class="col-sm-3">
								<div class="card" style="width: 15rem;">
									<input type="hidden" name="old_image_2" value="{{ $media->image_2 }}">
								  	<img 
								  		class="card-img-top img-thumbnail" 
							...
							<div class="col-sm-3">
								<div class="card" style="width: 15rem;">
									<input type="hidden" name="old_image_3" value="{{ $media->image_3 }}">
								  	<img 
								  		class="card-img-top img-thumbnail" 
							...
							<div class="col-sm-3">
								<div class="card" style="width: 15rem;">
									<input type="hidden" name="old_image_4" value="{{ $media->image_4 }}">
								  	<img 
								  		class="card-img-top img-thumbnail" 
